...
class ArticlesRepositoryModule {
    ...
    @Provides
    fun provideRemoteArticlesRepositoryModule(financeAPI: FinanceAPI): RemoteArticlesRepository {
        return RemoteArticlesRepositoryImpl(financeAPI)
    }

    @ArticlesComponentScope
    @Provides
    fun provideArticlesRepository(remoteArticlesRepository: RemoteArticlesRepository): ArticlesRepository {
