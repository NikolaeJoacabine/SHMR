...
import com.nikol.yandexschool.features.transaction.screens.expenses.stateHoisting.ExpensesScreenAction.ExpensesClicked
        ...
        items(transactions, key = { it.id }) { transaction ->
            CustomListItem(
                modifier = Modifier
                    .height(70.dp)
                    .clickable {
                        onAction(ExpensesClicked(transaction.id))
                    }
